...
interface CreateEventDialogEnhancedProps {
  open: boolean;
...
export function CreateEventDialogEnhanced({
  open,
  onOpenChange,
  communityId,
  onEventCreated,
}: CreateEventDialogEnhancedProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new event for your community with rich content
          </DialogDescription>
        </DialogHeader>
